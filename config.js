...
config.credentials.password = 'xxxxxxxxx';

//Demandware urls
config.urls = {};
config.urls.loginUrl = 'https://xxxxx-saksoff5th-saksfifthavenue.demandware.net/on/demandware.store/Sites-Site/en_US/ViewApplication-DisplayWelcomePage';
